        ...
        <div id="middle" style="height: 909px; width:1185px;">
            <div id="center-column" style="height: 850px; width: 1134px;">
                <div class="top-bar" style="width: 1118px; height: 100px;">
                    <a class="button" target="I1" style="float: right; height: 15px; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; width: 59px;" title="Back to all donor details" href="viewall.php">BACK</a>
                    <h1>All Donors</h1>
                ...
                <div class="style1" style="float: left; position: relative; width: 1117px; left: -1px; top: -9px;">
                    <table class="listing" cellpadding="0" cellspacing="0" style="width: 1130px">
