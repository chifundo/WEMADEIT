...
<div style="position: absolute; width: 987px; height: 870px; z-index: 1; left: 9px; top: 22px" id="layer8">
    <div id="main" style="height: 679px; width:980px;">
        <div id="middle" style="height: 890px; width:891px;">
            <div id="center-column" style="height: 856px; width: 969px;">
...
<p>
													...
													<div style="position: absolute; width: 725px; height: 38px; z-index: 2; left: 223px; top: 20px" id="layer5" class="style1">
					<strong>The Village SafeHaven</strong></div>
													<div style="position: absolute; width: 188px; height: 100px; z-index: 3; left: 226px; top: 81px" id="layer6">
														...
														South Africa<br />
														2066</div>
<div style="position: absolute; width: 390px; height: 100px; z-index: 4; left: 560px; top: 75px" id="layer7" class="style2">
	...
	village@polka.co.za</a></div>
				<div style="position: absolute; width: 833px; height: 593px; z-index: 5; left: 18px; top: 234px" id="layer9">
				 <div style="float: left; position: relative; width: 516px; left: -1px; top: 3px; height: 107px;">
              	...
              	<div style="position: absolute; width: 130px; height: 18px; z-index: 1; left: 787px; top: -79px" id="layer11">
				...
				School Report<div style="position: absolute; width: 143px; height: 21px; z-index: 6; left: 803px; top: 183px" id="layer10">
