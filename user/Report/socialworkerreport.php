...
<div style="position: absolute; width: 910px; height: 870px; z-index: 1; left: 9px; top: 22px" id="layer8">
    <div id="main" style="height: 679px; width:898px;">
        <div id="middle" style="height: 890px; width:891px;">
            <div id="center-column" style="height: 856px; width: 957px;">
...
<p>
													...
													<div style="position: absolute; width: 687px; height: 38px; z-index: 2; left: 223px; top: 20px" id="layer5" class="style1">
					<strong>The Village SafeHaven</strong></div>
													<div style="position: absolute; width: 188px; height: 100px; z-index: 3; left: 226px; top: 81px" id="layer6">
														...
														South Africa<br />
														2066</div>
<div style="position: absolute; width: 390px; height: 100px; z-index: 4; left: 522px; top: 76px" id="layer7" class="style2">
	...
	village@polka.co.za</a></div>
				...
				Social Worker Report<div style="position: absolute; width: 142px; height: 21px; z-index: 6; left: 768px; top: 186px" id="layer10">
				<?php date_default_timezone_set('UTC');
				echo date('j F Y'); ?>
				</div>
              	<div style="position: absolute; width: 130px; height: 16px; z-index: 1; left: 768px; top: 156px" id="layer11">
