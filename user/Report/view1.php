                ...
                <div class="style1" style="float: left; position: relative; width: 614px;">
                    <table class="listing" cellpadding="0" cellspacing="0" width="40%">
                       ...
                       <?php while($res=mysql_fetch_array($result)){ ?>
                        <tr>
                            <td class="style1"><?php echo $res['firstname']; ?>
							&nbsp;</td>
                            <td><?php echo $res['surname']; ?>
							&nbsp;</td>
                            <td><?php echo $res['age']; ?>
							&nbsp;</td>
                            ...
                            <td><?php echo "<a href=\"edit.php?orphan_id=$res[orphan_id]\"  target='I4'>Edit</a>"; ?>
							&nbsp;</td>
                            <td><?php echo "<a href=\"delete.php?orphan_id=$res[orphan_id]\" >Delete</a>"; ?>
							&nbsp;</td>
                        </tr>
