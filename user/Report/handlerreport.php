...
<div style="position: absolute; width: 910px; height: 870px; z-index: 1; left: 9px; top: 22px" id="layer8">
    <div id="main" style="height: 679px; width:898px;">
        <div id="middle" style="height: 890px; width:1151px;">
            <div id="center-column" style="height: 856px; width: 1101px;">
                <div class="top-bar" style="width: 87px">
                    <div class="breadcrumbs">
              	<div style="position: absolute; width: 130px; height: 16px; z-index: 1; left: 921px; top: 159px" id="layer11">
...
<p>
													...
													<div style="position: absolute; width: 835px; height: 38px; z-index: 2; left: 223px; top: 20px" id="layer5" class="style1">
					<strong>The Village SafeHaven</strong></div>
													<div style="position: absolute; width: 188px; height: 100px; z-index: 3; left: 226px; top: 81px" id="layer6">
														...
														South Africa<br />
														2066</div>
<div style="position: absolute; width: 390px; height: 100px; z-index: 4; left: 672px; top: 82px" id="layer7" class="style2">
	...
	village@polka.co.za</a></div>
				<div style="position: absolute; width: 833px; height: 128px; z-index: 5; left: 18px; top: 234px" id="layer9">
            	...
            	<br>
				<br>
                <div class="select-bar" style="width: 1050px">
				Handler Report<div style="position: absolute; width: 142px; height: 21px; z-index: 6; left: 920px; top: 184px" id="layer10">
