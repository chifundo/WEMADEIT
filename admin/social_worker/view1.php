                    ...
                    <table class="listing" cellpadding="0" cellspacing="0">
                       ...
                       <?php while($res=mysql_fetch_array($result)){ ?>
                        <tr>
							...
							&nbsp;</td>
                            <td><?php echo "<a href=\"edit.php?social_worker_id=$res[social_worker_id]\"  target='I4'>Edit</a>"; ?>
							&nbsp;</td>
                            <td onclick="confirmDelete()"><?php echo "<a href=\"delete.php?social_worker_id=$res[social_worker_id]\" >Delete</a>"; ?>
							&nbsp;</td>
                        </tr>
