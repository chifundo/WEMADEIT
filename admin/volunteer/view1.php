    ...
    <div id="main" style="height: 494px; width:500px;">
        <div id="middle" style="height: 472px; width:650px;">
            <div id="center-column" style="height: 439px; width: 610px;">
                ...
                <div class="style1" style="float: left; position: relative; width: 614px; font-size: 12pt;">
                    <table class="listing" cellpadding="0" cellspacing="0" width="40%">
                       ...
                       <?php while($res=mysql_fetch_array($result)){ ?>
                        <tr> 
							...
							&nbsp;</td>
                            <td ><?php echo $res['volunteer_fname']; ?>
							&nbsp;</td>
                            ...
                            <td><?php echo "<a href=\"edit.php?volunteer_id=$res[volunteer_id]\"  target='I4'>Edit</a>"; ?>
							&nbsp;</td>
                            <td onclick="confirmDelete()"><?php echo "<a href=\"delete.php?volunteer_id=$res[volunteer_id]\" >Delete</a>"; ?>
							&nbsp;</td>
                        </tr>
