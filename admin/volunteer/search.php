        ...
        <div id="middle" style="height: 489px; width:650px;">
            <div id="center-column" style="height: 455px; width: 610px;">
                <div class="top-bar">
                    ...
                    <a class="button" target="I1" style="float: right; height: 15px; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; width: 64px;" title="Back to all volunteer" href="new.php">BACK</a>
                    <h1>All Volunteer</h1>
                ...
                <div class="style1" style="float: left; position: relative; width: 614px; left: 0px; top: 0px; height: 59px; font-size: 12pt;">
...
<?php while ($row = mysql_fetch_array($sql)){?>
                        <tr> 
							...
							&nbsp;</td>
                            <td ><?php echo $row ['volunteer_fname']; ?>
							&nbsp;</td>
