$(document).ready(function(){
  ...
  $("#fname").blur(function(){chkname('adopter_fname');});
  $("#mname").blur(function(){ chkname('adopter_mname'); });
  $("#lname").blur(function() { chkname('adopter_lname'); });
  $("#relation").blur(function() { chkselect('relation'); });
  $("#telephone").blur(function() { chkname('telephone'); });
  $("#cellno").blur(function() { chkname('mobile'); });
  $("#email").blur(function() { chkname('email'); });


  $("#addressline1").blur(function() { chkname('adopter_addressline1'); });
  $("#addressline2").blur(function() { chkname('adopter_addressline2'); }); 
  $("#province").blur(function() { chkselect('adopter_province'); });

  $("#city").blur(function() { chkname('adopter_city'); }); 
  $("#country").blur(function() { chkname('adopter_country); });

  $("#postalcode").blur(function() { chkname('adopter_postalcodem'); });
