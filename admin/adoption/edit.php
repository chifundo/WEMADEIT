...
if(isset($_POST['name']))
{
	...
	$adopter=$_POST['adopter'];
		...
		echo "<font color='green'>Adoption Updated successfully.";
  ...
  -->
	...
	<tr>
      <td style="height: 26px; " colspan="2">
		...
		<input type="text" name="comment" maxlength="15" style="width: 298px; height: 21px" id="comment" title="Type Last Name Here" value="<?php echo $comment;?>" /></td>
    </tr>
    <tr>
