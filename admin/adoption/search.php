...
<div style="position: absolute; width: 686px; height: 870px; z-index: 1; left: -74px; top: 0px" id="layer8">
    <div id="main" style="height: 679px; width:500px;">
        <div id="middle" style="height: 890px; width:650px;">
            <div id="center-column" style="height: 856px; width: 610px;">
                <div class="top-bar">
                    <a class="button" target="I4" style="float: right; height: 15px; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px;" title="Add new adoption" href="input.php">ADD NEW</a>
                    <a class="button" target="I1" style="float: right; height: 15px; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; width: 69px;" title="Back to all adoption" href="new.php">BACK</a>
                    <h1>All Adoptions</h1>
...
<?php while ($row = mysql_fetch_array($sql)){?>
                        <tr>
							...
							&nbsp;</td>                          
                            <td><?php echo "<a href=\"edit.php?adoption_id=$row[adoption_id]\"  target='I4'>Edit</a>";?>
							&nbsp;</td>
                            <td onclick="confirmDelete()"><?php echo "<a href=\"delete.php?adoption_id=$row[adoption_id]\" >Delete</a>";?>
							&nbsp;</td>
                        </tr>
