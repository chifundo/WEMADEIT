        ...
        <div id="middle" style="height: 890px; width:1292px;">
            <div id="center-column" style="height: 856px; width: 1292px;">
                <div class="top-bar" style="width: 1173px">
                    <a class="button" target="I1" style="float: right; height: 15px; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px; width: 68px;" title="Back to relation view" href="new.php">BACK</a>
                    &nbsp;<h1>All Relations</h1>
                ...
                <div class="style1" style="float: left; position: relative; width: 1022px; left: 0px; top: 0px;">
                    <table class="listing" cellpadding="0" cellspacing="0" style="width: 1187px; font-size: small;">
