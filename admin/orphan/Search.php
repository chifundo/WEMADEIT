    ...
    <div id="main" style="height: 679px; width:500px;">
        <div id="middle" style="height: 890px; width:650px;">
            <div id="center-column" style="height: 856px; width: 610px;">
                <div class="top-bar">
                    <a class="button" target="I4" style="float: right; height: 15px; border-radius: 7px; -moz-border-radius: 7px; -webkit-border-radius: 7px;" title="Add new Orphan" href="input.php">ADD NEW  
					</a>
...
<?php while ($row = mysql_fetch_array($sql)){?>
                            ...
                            <td><?php echo "<a href=\"edit.php?orphan_id=$row[orphan_id]\"  target='I4'>Edit</a>"; ?>
							&nbsp;</td>
