$(document).ready(function(){
  ...
  $("#gender").blur(function() { chkselect('orphan_gender'); });
...
var odob=chkselect('dob');
var ogen=chkselect('orphan_gender');
...
if((ofnam==true) && (omnam==true)  && (olnam==true)&& (odob==true) && (ogen==true) && (orace==true) && (otype==true) && (oloc==true) && (osw==true) && (ohand==true)
 ...
 if(($("#fname").val()!="")&& ($("#mname").val()!="") && ($("#lname").val()!="")&&($("#dob").val()!="") &&($("#gender").val()!="") &&($("#race").val()!="") 
 				&&($("#type").val()!="") &&($("#location").val()!="") &&($("#social_worker").val()!="") &&($("#handler").val()!="") &&($("#next_of_kin").val()!="")
 			    &&($("#school").val()!="") &&($("#adoption").val()!="")){
...
//==================Validate Gender==========================
function chkselect(orphan_gender)
{
   $value=$('#'+orphan_gender).val();
  
  if($value=="Choose Gender" || $value=="" )
   {
    setalert(orphan_gender+'span',$gendererr);
     return false;
    }
  else{
            clearalert(orphan_gender+'span');
            return true;
   }
