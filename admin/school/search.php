...
<?php $sql = mysql_query("SELECT * FROM school WHERE school_name like '%$term%' OR principle_fname  
										like '%$term%'OR principle_mname  like '%$term%'OR principle_lname  like '%$term%'");?>
 
<?php while ($row = mysql_fetch_array($sql)){?>
                        <tr>
                        	<td><?php echo $row ['school_name']; ?>
							&nbsp;</td>
                            <td ><?php echo $row ['principle_fname']; ?> &nbsp;&nbsp;<?php echo $row ['principle_lname']; ?> 
							&nbsp;</td>
                            ...
                            <td><?php echo "<a href=\"newedit.php?school_id=$row [school_id]\"  target='I1'>Edit</a>"; ?>
							&nbsp;</td>
                            <td  onclick="confirmDelete()"><?php echo "<a href=\"delete.php?school_id=$row [school_id]\" >Delete</a>"; ?>
							&nbsp;</td>
                        </tr>
