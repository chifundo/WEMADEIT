$(document).ready(function(){
  ...
  $("#affiliation").blur(function() { chkselect('affiliation'); });
...
var oaff=chkselect('affiliation');
...
var oprov=chkname('province');
var ocou=  chkname('country');

if((otit==true) &&(ofnam==true)&& (omnam==true)  && (olnam==true) && (oaff==true) && (oemail==true) && (omono==true) && (otel==true) && (ofax==true) && (oadd1==true) 
		&& (oadd2==true) && (ocity==true) && (opost==true) && (oprov==true) && (ocou==true)){
 if(($("#title").val()!="")&&($("#fname").val()!="")&& ($("#mname").val()!="") && ($("#lname").val()!="") &&($("#affiliation").val()!="") &&($("#email").val()!="") &&($("#cellno").val()!="")
 			 &&($("#telephone").val()!="") &&($("#fax").val()!="") &&($("#adddresline1").val()!="")&&($("#addressline2").val()!="") &&($("#city").val()!="") &&($("#postalcode").val()!="")
 			 &&($("#province").val()!="") &&($("#country").val()!="") ){
     if(($("#titlespan").val()=="")&&($("#fnamespan").val()=="")&&($("#mnamespan").val()=="")&&($("#lnamespan").val()=="")&& ($("#affiliationspan").val()=="")&&($("#emailspan").val()=="")
...
function chkselect(affiliation)
{
   $value=$('#'+affiliation).val();
  
  if($value=="Choose Affiliation" || $value=="" )
   {
    setalert(affiliation+'span',$affiliationerr);
     return false;
    }
  else{
            clearalert(affiliation+'span');
            return true;
   }
