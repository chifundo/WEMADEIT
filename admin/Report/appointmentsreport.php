        ...
        <div id="middle" style="height: 890px; width:891px;">
            <div id="center-column" style="height: 856px; width: 943px;">
                <div class="top-bar" style="width: 87px">
              	...
              	<div style="position: absolute; width: 121px; height: 22px; z-index: 1; left: 725px; top: 153px" id="layer11">
					 <script type="text/javascript">
					 </script>
					<a style=" color:#6D9F00; text-decoration:none;" class="printfriendly" onclick="window.print(); return false;" title="Printer Friendly and PDF">
...
<p>
					...
					<strong>The Village SafeHaven</strong></div>
													<div style="position: absolute; width: 188px; height: 100px; z-index: 3; left: 226px; top: 81px" id="layer6">
														...
														South Africa<br />
														2066</div>
<div style="position: absolute; width: 390px; height: 53px; z-index: 4; left: 480px; top: 85px" id="layer7" class="style2">
