...
$result = mysql_query( "SELECT orphans.*, school.*
						FROM orphans, school
						WHERE orphans.school_id = school.school_id
...
<title>SafeHaven | School Report</title>
...
<div style="position: absolute; width: 1084px; height: 870px; z-index: 1; left: 9px; top: 22px" id="layer8">
    <div id="main" style="height: 679px; width:1078px;">
...
<p>
													...
													<div style="position: absolute; width: 913px; height: 38px; z-index: 2; left: 223px; top: 20px" id="layer5" class="style1">
					<strong>The Village SafeHaven</strong></div>
													<div style="position: absolute; width: 188px; height: 100px; z-index: 3; left: 226px; top: 81px" id="layer6">
														...
														South Africa<br />
														2066</div>
<div style="position: absolute; width: 574px; height: 100px; z-index: 4; left: 560px; top: 75px" id="layer7" class="style2">
	...
	village@polka.co.za</a></div>
				<div style="position: absolute; width: 1118px; height: 593px; z-index: 5; left: 18px; top: 234px" id="layer9">
				 <div style="float: left; position: relative; width: 1116px; left: -1px; top: 3px; height: 107px;">
                    <table class="listing" cellpadding="0" cellspacing="0" style="width: 1111px;">
                       ...
                       <?php while($res=mysql_fetch_array($result)){ ?>
                        <tr>
							...
							&nbsp;</td>
                            <td><?php echo $res['principle_fname']; ?>
							&nbsp;</td>
							...
							&nbsp;</td>
							<td><?php echo $res['school_address_line2']; ?>
							&nbsp;</td>
              	...
              	<div style="position: absolute; width: 130px; height: 18px; z-index: 1; left: 982px; top: -83px" id="layer11">
            	...
            	<br>
				<br>
                <div class="select-bar" style="width: 1112px">
				School Report<div style="position: absolute; width: 143px; height: 21px; z-index: 6; left: 996px; top: 185px" id="layer10">
