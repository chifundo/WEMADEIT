...
<p>
					...
					<strong>The Village SafeHaven</strong></div>
													<div style="position: absolute; width: 188px; height: 100px; z-index: 3; left: 226px; top: 81px" id="layer6">
														...
														South Africa<br />
														2066</div>
<div style="position: absolute; width: 390px; height: 63px; z-index: 4; left: 720px; top: 74px" id="layer7" class="style2">
	...
	village@polka.co.za</a></div>
				...
				echo date('j F Y'); ?>
              	...
              	<div style="position: absolute; width: 130px; height: 20px; z-index: 1; left: 967px; top: 156px" id="layer11">
